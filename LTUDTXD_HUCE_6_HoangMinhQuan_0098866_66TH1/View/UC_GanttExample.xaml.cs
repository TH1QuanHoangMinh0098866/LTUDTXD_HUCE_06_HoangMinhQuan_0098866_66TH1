...
namespace LTUDTXD_HUCE_6_HoangMinhQuan_0098866_66TH1.View
{
    public partial class UC_GanttExample : UserControl, INotifyPropertyChanged
    {
        private double _from;
        private double _to;
        private readonly ChartValues<GanttPoint> _values;

        public UC_GanttExample()
        {
            InitializeComponent();
